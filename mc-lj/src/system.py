...
class System:
    ...
    def __init__(self, temperature, interaction, parameters, dim=3, config='cubic', positions=None):
        ...
        self._energy = self.interaction.compute_energy(self.positions,self.box)
...
################################################################
    ...
    @property
    def energy(self):
        return self._energy/self.positions.shape[1]
